...
validProposal  _ originateFn = do
  ...
  callFrom (AddressResolved owner1) dao (Call @"Get_total_supply") (mkView unfrozenTokenId consumer)
  ...
  callFrom (AddressResolved owner1) dao (Call @"Get_total_supply") (mkView frozenTokenId consumer2)
